...
::: bad  
![Figure: Bad Example - asking someone to do work in a conversation](/rules/using-the-conversation-tab-to-task-out-work/teams - tasking in conversation.png)  
:::


::: good  
![Figure: Good Example - task is added to the backlog](/rules/using-the-conversation-tab-to-task-out-work/teams - add to backlog.png)  
:::
