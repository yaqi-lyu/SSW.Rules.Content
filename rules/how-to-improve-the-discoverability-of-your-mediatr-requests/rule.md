...
![Figure: A Typical ASP.NET Controller using Mediator](/rules/how-to-improve-the-discoverability-of-your-mediatr-requests/improve-mediatr-typical.png)  
...
::: bad  
![Figure: Bad Example - The request is contained within CreateProductCommand.cs](/rules/how-to-improve-the-discoverability-of-your-mediatr-requests/improve-mediatr-bad.png)  
:::


::: bad  
![Figure: Bad Example - The request handler is contained within CreateProductCommandHandler.cs](/rules/how-to-improve-the-discoverability-of-your-mediatr-requests/improve-mediatr-bad-2.png)  
:::
...
::: good  
![Figure: Good Example - Nesting the Request Handler within the Request Improves Discoverability of Command and Associated Command Logic](/rules/how-to-improve-the-discoverability-of-your-mediatr-requests/improve-mediatr-good.png)  
:::
