...
![Figure: SQL Server now creates groups for all the SQL Server services with the bare minimum permissions for you](/rules/run-sql-server-services-under-non-administrator-accounts/SQLDatabases_RunAsAccount_GroupsCreated.png)  
