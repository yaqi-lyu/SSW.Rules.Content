...
![Figure: There are 3 spikes to investigate (one on each graph), but which is the most important? Hint: look at the scales!](/rules/do-you-know-how-to-find-performance-problems-with-application-insights/performance-1.jpg)  
...
![Figure: The 'Average of Browser page load time by URL base' graph will highlight the slowest page.](/rules/do-you-know-how-to-find-performance-problems-with-application-insights/performance 2.png)  
...
![Figure: In this case, the user agent string gives away the cause, Baidu (a Chinese search engine) got stuck and failed to index the page.](/rules/do-you-know-how-to-find-performance-problems-with-application-insights/performance-3.png)  
...
![Figure: In this case, the most important detail to action is the Get Healthcheck issue. Now you should be able to optimise the slowest pages](/rules/do-you-know-how-to-find-performance-problems-with-application-insights/performance-4.jpg)  
...
![](/rules/do-you-know-how-to-find-performance-problems-with-application-insights/distribution.png)
