...
::: bad  
![Figure: Bad Example - Low contrast between disabled and active button styles.](/rules/controls-do-you-disable-buttons-that-are-unavailable/disabled-button-bad.png)  
:::

::: good
![Figure: Good Example - High contrast creates distinct visual hierarchy](/rules/controls-do-you-disable-buttons-that-are-unavailable/disabled-button-good.png)  
:::
