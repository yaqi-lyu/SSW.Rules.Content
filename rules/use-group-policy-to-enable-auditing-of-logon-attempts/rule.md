...
![Figure: Select 'Audit logon events'](/rules/use-group-policy-to-enable-auditing-of-logon-attempts/failed-login-1.png)  
...
![Figure: Select 'Audit: Force audit policy...'](/rules/use-group-policy-to-enable-auditing-of-logon-attempts/failed-login-2.png)  



![Figure: Successful and Failed login attempts will now appear in Event Viewer | Security](/rules/use-group-policy-to-enable-auditing-of-logon-attempts/failed-login-3.png)  
