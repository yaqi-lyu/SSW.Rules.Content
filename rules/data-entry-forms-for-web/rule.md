...
::: bad  
![Figure: Bad example - Ambiguous controls](/rules/data-entry-forms-for-web/bad-form-controls.png)  
:::

::: good  
![Figure: Good example - Well defined controls and associated actions](/rules/data-entry-forms-for-web/Good-form-controls.png)  
:::
...
::: bad  
![Figure: Bad example - Design fails on smaller views](/rules/data-entry-forms-for-web/Bad-responsive.png)  
:::

::: good  
![Figure: Good example - Responsive design for smaller views](/rules/data-entry-forms-for-web/Good-responsive.png)  
:::
...
::: bad  
![Figure: Bad example - This form has left alignment and non-decimal values](/rules/data-entry-forms-for-web/Bad-Example-Form-Formating.png)  
:::

::: good  
![Figure: Good example - These fields have appropriate width for the data](/rules/data-entry-forms-for-web/Good-Example-Form-Formating.png)  
:::
...
::: good  
![Figure: Good example - This form contains the date as that can be safely prepopulated](/rules/data-entry-forms-for-web/minimum-defaults.png)  
:::
...
::: good  
![Figure: Good example - A scrolling effect added to the validation](/rules/data-entry-forms-for-web/validation-scroll.gif)  
:::
...
::: bad  
![Figure: Bad example - This form does not contain Created by/Updated by fields](/rules/data-entry-forms-for-web/NoCreatedUpdatedField.png)  
:::

::: good  
![Figure: Good example - This form contains Created by/Updated by fields](/rules/data-entry-forms-for-web/FormWithCreatedUpdatedFields.png)  
:::
...
::: bad  
![Figure: Bad example - Delete buttons shown](/rules/data-entry-forms-for-web/Delete-Button-grid.png)  
:::

::: good  
![Figure: Good example - This grid contains no delete button, requiring the user to examine the entire record via "Edit" before deletion](/rules/data-entry-forms-for-web/NoDeleteButtonOnGrid.png)  
:::
...
![Figure: Exception - This grid contains delete button because all of the required information can be seen from the main form](/rules/data-entry-forms-for-web/AppropriateUseOfRemove.png)  
