...
::: bad
![Figure: Bad example - Conditionals and concurrency in main workflow](/rules/keep-conditional-actions-concurrency-main-workflow//rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-main-pipeline.png)
:::
...
::: bad
![Figure: Bad example - Conditionals and concurrency in called workflow](/rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-calledworkflow.png)
:::
...
::: good
![Figure: Good example - Only the main workflow has conditional and concurrency](/rules/keep-conditional-actions-concurrency-main-workflow//rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-main-pipeline.png)
:::

::: good
![Figure: Good example - Called workflow doesn't contain conditionals or concurrency groups](/rules/keep-conditional-actions-concurrency-main-workflow/github-concurrency-calledworkflow-good.png)
:::
