...
![Figure: A QR code on a Microsoft newsletter, which allows customers to scan and follow the business account](/rules/all-the-things-you-can-use-qr-code-for/Microsoft-official-account.gif) 

![Figure: The WeChat app can scan the QR code, which then allows the customer to click the Follow button. They will then receive regular updates](/rules/all-the-things-you-can-use-qr-code-for/Follow-official-account.png) 
...
![Figure: Customize WeChat’s personal QR code by changing the style](/rules/all-the-things-you-can-use-qr-code-for/personal-qr-code.png)

![Figure: Tap and hold on a QR image to extract a QR code](/rules/all-the-things-you-can-use-qr-code-for/extract-a-qr-code.png) 
...
![Figure: How to show your "Pay me" QR code on Alipay](/rules/all-the-things-you-can-use-qr-code-for/receive-money-alipay.png) 
...
![Figure: How to show your “Pay Vendor” QR code on WeChat](/rules/all-the-things-you-can-use-qr-code-for/pay-vendor-wechat.png) 

![Figure: How to show your “Pay Vendor” QR code on Alipay](/rules/all-the-things-you-can-use-qr-code-for/pay-vendor-alipay.png) 
...
![Figure: Use WeChat to scan the QR code and view product information in a supermarket](/rules/all-the-things-you-can-use-qr-code-for/product-info-qrcode.jpeg) 
...
![Figure: A government-sponsored billboard in Hangzhou showcasing apps for tourists](/rules/all-the-things-you-can-use-qr-code-for/install-apps-qr-code.jpeg)
...
![Figure: Use WeChat to sign-up and login to Zhihu (a Chinese Quora alternative)](/rules/all-the-things-you-can-use-qr-code-for/zhihu-login.png)
...
![Figure: Use the Weibo App to scan a QR code to login to their services on the web](/rules/all-the-things-you-can-use-qr-code-for/weibo-login.png)
...
![Figure: How to connect to a public hotspot](/rules/all-the-things-you-can-use-qr-code-for/hotspot-qr-code.jpg)
...
![Figure: How to ride a bus using the Alipay QR code in Hangzhou](/rules/all-the-things-you-can-use-qr-code-for/ride-bus-qr-code.jpg)

![Figure: Presenting your QR code to a bus scanner](/rules/all-the-things-you-can-use-qr-code-for/show-qr-code-bus.jpg) 
...
![Figure: How to rent a Hellobike using the Alipay App](/rules/all-the-things-you-can-use-qr-code-for/sharing-bike-qr-code.png)
