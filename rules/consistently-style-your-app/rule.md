...
::: bad  
![Figure: Bad Example - same styling defined and repeated multiple times](/rules/consistently-style-your-app/xamarin-style-bad.png)  
:::


::: good  
![Figure: Good Example - Styles defined once in resource dictionary and applied to controls](/rules/consistently-style-your-app/xamarin-style-good.png)  
:::
