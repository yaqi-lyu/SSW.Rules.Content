...
![Figure: Bypass spam filtering setting in Exchange](/rules/ensure-zendesk-is-not-marked-as-spam/bypass-spam-filtering.png)  
...
![Figure: Adding domain to bypass list](/rules/ensure-zendesk-is-not-marked-as-spam/adding-domain-to-bypass-list.png)  
