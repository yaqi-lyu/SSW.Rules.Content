...
2. Share the dll from the directory, so if I want SSW.Framework.Configuration, I go to $/ssw/SSWFramework/Configuration/bin/Release/
    ...
    I select both the dll and the dll.xml files, right-click and drag them into my $/ssw/zzRefs/References/ folder that I just created in step 1. ![Use Dlls Xml](/rules/do-you-reference-very-calm-stable-dlls-by-assembly/use_dllsxml.jpg)**Figure: Select the dlls that I want to use** ![Use right click to share](/rules/do-you-reference-very-calm-stable-dlls-by-assembly/use_rightclicktoshare.jpg)**Figure: Right drag, and select "Share"**
3. Still in SourceSafe, select the References folder, run get latest?to copy the latest version onto your working directory.
![Use Get Latest](/rules/do-you-reference-very-calm-stable-dlls-by-assembly/use_getlatest.jpg)**Figure: Get Latest from Visual Source Safe** VSS may ask you if you want to create the folder, if it doesnt exist. Yes, we do.
...
![Use Include Invs](/rules/do-you-reference-very-calm-stable-dlls-by-assembly/use_includeinvs.jpg)**Figure: Include the files into the current project**
...
![Use Undo Checkout](/rules/do-you-reference-very-calm-stable-dlls-by-assembly/use_undocheckout.jpg)**Figure: Undo Checkout, when VS.NET checked them out for you...**
