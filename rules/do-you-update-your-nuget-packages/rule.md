...
::: good  
![Figure: Good example -  NuGet packages via Package Manager are all up-to-date](/rules/do-you-update-your-nuget-packages/nuget-update1.png)  
:::

![Figure: Update one package at a time eg. The command 'Update-Package EntityFramework' will update the one NuGet package via the Package Manager Console. Then test](/rules/do-you-update-your-nuget-packages/nuget-update2.png)  
