...
![Figure: Steps to install NuGet Packages](/rules/do-you-know-the-code-health-quality-gates-to-add/VS-InstallNuGetPackages.png)
...
![Figure: New Roslyn Rule issues raised in Visual Studio Analyzer](/rules/do-you-know-the-code-health-quality-gates-to-add/VS-RoslynRules.png)
...
![Figure: Addition of CSSLint and ESLint to VS Code Project](/rules/do-you-know-the-code-health-quality-gates-to-add/vs-code-extensions.png)
...
![Figure: Steps to edit an existing build definition on VisualStudio.com](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-EditBuild.png)
...
![Figure: Example completed build definition](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildDefinition-V3.png)

![Figure: Example directory for TSLint run commands](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-DirectoryExampleV2.png)
...
![Figure: Command line step to remove the config file (tslint.json) after the linter has run](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-RemoveConfig.png)
...
![Figure: Ensure TSLint actually finds files to scan (if the project includes TSLint files) otherwise it will pass without you noticing](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-EnsureTSLintRuns.png)
...
![Figure: Steps to add PrimaryBuild variable to build definition](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-AddVariableTag.png)

::: bad
![Figure: Bad example - Build broke due to compile errors. Must fix to proceed](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildResult-BadV3.png)
:::

::: bad
![Figure: Bad example - Successful build with warnings. Should be disabled or set as errors](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildResultV3.png)
:::

::: good
![Figure: Good example - Successful build with no warnings](/rules/do-you-know-the-code-health-quality-gates-to-add/VSO-BuildResult-GoodV3.png)
:::
