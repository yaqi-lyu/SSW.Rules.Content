...
![Figure: This report shows the last time each user did a Get from TFS](/rules/do-you-know-to-regularly-do-a-get-latest-from-tfs/SidekicksWorkspaceLastGet.png)
