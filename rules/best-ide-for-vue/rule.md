...
::: good
![Figure: Good example - Visual Studio Code is a great free, lightweight and extensible code editor that runs on Windows, Linux and macOS](/rules/best-ide-for-vue/vs-code.png)
:::
...
::: good
![Figure: Good example – the Volar extension will provide everything you need to start developing for Vue.js in Visual Studio Code](/rules/best-ide-for-vue/volar.png)
:::
...
![Figure: TypeScript Vue Plugin can help make TypeScript development within Vue.js easier](/rules/best-ide-for-vue/volar-ts.png)
