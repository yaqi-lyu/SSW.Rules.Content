...
::: bad  
![Figure: Bad Example - Unclear labels on the buttons](/rules/do-you-label-your-form-buttons-consistently/ButtonLabels_Bad.gif)  
:::
...
::: good  
![Figure: Good Example - This form uses the standard button naming standards (and has the Default buttons set!)](/rules/do-you-label-your-form-buttons-consistently/OKCancelExampleDialog.jpg)  
:::
