...
![Figure: Add a zsApplication table to make applications that use it visible to all developers](/rules/design-for-database-change/SQLDatabases_zsApplication.png)  
