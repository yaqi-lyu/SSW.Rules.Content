...
::: bad  
![Figure: Bad Example - New button should open another form, and Delete button should be on that new form](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/BadAddDeleteSubForm.gif)  
:::
...
::: good  
![Figure: Good Example - Outlook opens multiple instances of the data entry form (email message)](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/Outlookemails.jpg)  
:::

::: good  
![Figure: Good example - Each form instance is shown in the taskbar, and easily opened again](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/outlooktaskbar.jpg)  
:::
...
::: good  
![Figure: Good example - New and Delete buttons docked in the Toolbar providing easy data entry for new Timesheets](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/GoodAddDeleteSubForm.jpg)  
:::
...
::: good  
![Figure: Good example - Save Changes Dialog must appear when form is dirty](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/SaveChangesDialog.jpg)  
:::
...
::: bad  
![Figure: Bad example - This implementation of a search utility is on the same form](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/BadSearch.gif)  
:::

::: good  
![Figure: Good example - This implementation of Search feature is on a separate form](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/SearchForm.gif)  
:::
...
::: good  
![Figure: Good example - No Delete button for Sub forms](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/SubFormsExample.gif)  
:::
...
::: good  
![Figure: Good example - Error Provider Icon next to a required field](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/ErrorProviderIconExample.jpg)  
:::
...
::: bad  
![Figure: Bad example - Action and Tools are irrelevant on this form](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/MenuBadExample.jpg)  
:::

::: good  
![Figure: Good example - Menus are relevant](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/MenuGoodExample.jpg)  
:::
...
::: bad  
![Figure: Bad example - This form has no information to indicate who created this entry and who last modified it](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/BadCreatedUpdated.jpg)  
:::

::: good  
![Figure: Good example - This form contains Created by/Updated by fields used in a standard control which is put into all forms](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/GoodCreatedUpdated.jpg)  
:::
...
![Figure: Data Binding using the Designer](/rules/do-you-know-the-correct-way-to-develop-data-entry-forms/CommonFieldsDB.gif)  
