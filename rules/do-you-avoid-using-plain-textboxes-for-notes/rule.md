...
::: bad  
![Figure: Bad Example - use of a plain textbox limits the detail of the user's notes](/rules/do-you-avoid-using-plain-textboxes-for-notes/BadNotes.jpg)  
:::


::: good  
![Figure: Good Example - with use of a rich textbox, you can use features such as bold, underline, highlighting and hyperlinks.](/rules/do-you-avoid-using-plain-textboxes-for-notes/GoodNotes.jpg)  
:::
