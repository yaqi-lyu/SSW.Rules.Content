...
::: bad  
![Bad Example: Domain is cluttered with data annotations](/rules/keep-your-domain-layer-independent-of-the-data-access-concerns/domain-layer-1.png)  
:::
...
![](/rules/keep-your-domain-layer-independent-of-the-data-access-concerns/domain-layer-2.png)  

![](/rules/keep-your-domain-layer-independent-of-the-data-access-concerns//rules/keep-your-domain-layer-independent-of-the-data-access-concerns/domain-layer-3.png)

::: good  
![Good Example: Domain is lean, configuration for entity is contained within a separate configuration type](/rules/keep-your-domain-layer-independent-of-the-data-access-concerns//rules/keep-your-domain-layer-independent-of-the-data-access-concerns/domain-layer-3.png)  
:::
...
![Figure: Database implementation is a Infrastructure concern not a Domain concern](/rules/keep-your-domain-layer-independent-of-the-data-access-concerns/CA_Animation_4.gif)
