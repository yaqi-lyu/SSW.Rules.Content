...
![Figure: HTTPS GET commits from your repository](/rules/do-you-know-how-to-programmatically-get-git-commits/devops-get-commits.png)
...
![Figure: Using the Chrome extension Postman to execute our request with Basic Authentication](/rules/do-you-know-how-to-programmatically-get-git-commits/8-08-2014-4-24-34-PM-compressor.png)
