...
![Figure: Using Power Automate is the preferred workflow engine](/rules/when-to-use-power-automate-vs-internal-workflow-engine/power-automate.png)  
...
![Figure: Built-in workflow engine](/rules/when-to-use-power-automate-vs-internal-workflow-engine/builtin-workflow.png)
