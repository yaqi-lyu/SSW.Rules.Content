...
::: good  
![Figure: Good Example - Create a Deployment project alongside your web project.](/rules/do-you-create-a-deployment-project-alongside-your-web-application-for-any-additional-deployment-steps/deployment-project.jpg)  
:::
...
![Figure: It is important that each of the batch and parameters files has it ‘Copy to Output Directory’ setting set to ‘Copy Always’](/rules/do-you-create-a-deployment-project-alongside-your-web-application-for-any-additional-deployment-steps/deployment-project-copy.jpg)
