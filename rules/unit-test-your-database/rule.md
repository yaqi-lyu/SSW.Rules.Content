...
![Figure: Database Unit Test](/rules/unit-test-your-database/AddNewTest.jpg)

![Figure: Writing the unit test against a stored proc](/rules/unit-test-your-database/WriteUnitTest.jpg)
