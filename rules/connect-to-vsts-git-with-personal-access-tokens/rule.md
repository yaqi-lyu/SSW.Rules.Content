...
::: bad  
![Figure: Bad Example - Alternate  Authentication Credentials should not be used. When you change the password it invalidates all projects and can't be scoped to limit access to your Team Services data](/rules/connect-to-vsts-git-with-personal-access-tokens/vsts-alternative-login.png)  
:::
...
::: good  
![Figure: Good Example - Windows for Git credential manager will automatically create Personal Access Token for Git](/rules/connect-to-vsts-git-with-personal-access-tokens/git-credentials-personal-access-token.png)  
:::
...
::: good  
![Figure: Good Example - You can also manually enter Personal Access Token into password section if the credential manager doesn't work](/rules/connect-to-vsts-git-with-personal-access-tokens/git-credentials-personal-access-token-manual.png)  
:::
