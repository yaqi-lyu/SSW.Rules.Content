...
1. Go to **Main | Marketing | Marketing Lists**
   ...
   ![Figure: This is where you can find your Marketing Lists in Microsoft Dynamics CRM 2016](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Go-To-Marketing-Lists.jpg)
...
3. Go to **... | Mail Merge on List Members** (in the menu bar)
   ...
   ![Figure: Click the ellipsis button to reveal the Mail Merge option](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Go-To-Mail-Merge-On-List-Members.jpg)
4. Select Email as the mail merge type, choose your starting document, (optional) select data fields to use, and download the .docx
   ...
   ![Figure: This is an example of a configuration to start with](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Download-Mail-Merge-Template.jpg)
5. Open the document in Word and follow the instructions in the document to start the Mail Merge

   ![Figure: Follow these steps to start working on the mail merge](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Set-Up-Word-Document.jpg)
6. Exclude contacts and press **OK**

   ![Figure: Choose the recipients for your mail merge and proceed](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Select-Contacts.jpg)
...
8. If necessary, go to  **File | (Info) | Convert** to update the Word document to the newest version - this will solve styling issues while not breaking the mail merge
   ...
   ![Figure: Convert the mail merge document to the newest version](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Convert-Document.jpg)
...
10. Follow the steps in the mail merge sidebar on the right-hand side of Word
    ...
    ![Figure: The highlighted part will change for every recipient](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Verify-Changes.jpg)
11. Send the mail merge newsletter to the email address property of every contact by selecting the following

    ![Figure:  Example configuration for the email that is about to be sent](/rules/how-to-send-newsletter-in-microsoft-crm-2016/Send-Mail-Merge-Newsletter.jpg)
