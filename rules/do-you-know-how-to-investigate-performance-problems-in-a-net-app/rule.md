...
![Figure: Read Write indicates that the Query Store is setup to help us a few days later](/rules/do-you-know-how-to-investigate-performance-problems-in-a-net-app/QueryStore1.png)  
...
![Figure: A couple of days later… Query Store can now be queried to determine which queries are now performing poorly](/rules/do-you-know-how-to-investigate-performance-problems-in-a-net-app/QueryStore3.png)  
...
![Figure: The query store can show the top 25 regressed queries in the last 2 weeks and give suggestions on how to improve them](/rules/do-you-know-how-to-investigate-performance-problems-in-a-net-app/QueryStore2.png)  
...
![](/rules/do-you-know-how-to-investigate-performance-problems-in-a-net-app/QueryStore4.png)
