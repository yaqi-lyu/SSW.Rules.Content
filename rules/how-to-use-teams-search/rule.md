...
![Figure: Search results for "marketing"](/rules/how-to-use-teams-search/teams-search-dropdown.png)  
...
![Figure: Use the 3 built-in tabs to search through the different types of results](/rules/how-to-use-teams-search/teams-search-tabs.png)  
...
![Figure: Built-in filters for Messages](/rules/how-to-use-teams-search/teams-search-filter.png)  
