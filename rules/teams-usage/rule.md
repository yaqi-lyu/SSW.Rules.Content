...
![Figure: Access team usage from "Team Settings" | "Manage Team" | "Analytics"](/rules/teams-usage/teams-team-usage.jpg)
...
![Figure: Access tenant level usage via "Office 365 Admin Center" | "Reports" | "Usage" | "View More" (under Microsoft Teams activity section)](/rules/teams-usage/teams-tenant-usage.jpg)

Now enjoy the full power of Teams usage analytics!

![Figure: click on column names to sort data (e.g. "Chat Messages")](/rules/teams-usage/teams-tenant-usage-home.jpg)
