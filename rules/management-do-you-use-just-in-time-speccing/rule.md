...
![Figure: Just-In-Time speccing in an agile Scrum project can handle evolving requirements](/rules/management-do-you-use-just-in-time-speccing/jit-speccing.png)
