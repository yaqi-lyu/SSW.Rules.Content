...
![You expand a VHD from the Actions Menu | Edit Disk](/rules/do-you-know-how-to-expand-your-vhds-when-you-are-low-on-space/actions-expand.jpg)
...
![The first partition on the disk needs to be expanded to use up the unallocated space created when expanding the VHD](/rules/do-you-know-how-to-expand-your-vhds-when-you-are-low-on-space/expand-freespace.jpg)
...
5. Click  **Finish
![The disk is now using all the available space inside the VHD ](/rules/do-you-know-how-to-expand-your-vhds-when-you-are-low-on-space/expand-fullspaceused.jpg)** **Figure: The disk is now using all the available space inside the VHD**
