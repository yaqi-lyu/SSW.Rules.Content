...
![Figure: Xero Expense app submit a photo](/rules/claim-expense-reimbursements-with-xero/Xero-Expense-app-submit-a-photo.png)
...
::: img-medium
![Figure: Details required of a submitted receipt](/rules/claim-expense-reimbursements-with-xero/Details-required-of-receipt.jpg)
:::

3. Confirm whether the expense was paid personally or with company money

![Figure: Option of reimbursable and non-reimbursable](/rules/claim-expense-reimbursements-with-xero/Reimbursable-or-non-reimbursable.png) 
...
![Figure: Saving as draft or submit for approval](/rules/claim-expense-reimbursements-with-xero/Saving-as-draft-or-submitting-as-approval.png) 
...
![Figure: Xero Expense claim approval page](/rules/claim-expense-reimbursements-with-xero/Xero-Expense-claim-approval.png)

4. Schedule for reimbursement to be in line with the upcoming pay

![Figure: Xero payment scheduling page](/rules/claim-expense-reimbursements-with-xero/Xero-payment-scheduling.png)

5. Submit the reimbursement along with wage payments

6. Send remittance to employee via Xero 

![Figure: Send remittance page post payment](/rules/claim-expense-reimbursements-with-xero/Send-remittance-page.png)
