...
::: bad  
![Figure: Bad Example - Custom database connection screen in Speed Ferret](/rules/connection-stream-do-you-use-a-udl-when-getting-database-settings/CustomDatabaseConnectionScreen.jpg)  
:::
...
::: good  
![Figure: Good Example - Standard Microsoft UDL dialog](/rules/connection-stream-do-you-use-a-udl-when-getting-database-settings/StandardMSUDLDialog.jpg)  
:::
...
![Figure: Coming in Visual Studio .NET 2005 Microsoft are yet to release an API to do this](/rules/connection-stream-do-you-use-a-udl-when-getting-database-settings/ReleaseAPI.jpg)  
...
![Figure: SQL Deploy uses its own custom form for "selecting" a database name](/rules/connection-stream-do-you-use-a-udl-when-getting-database-settings/SQLDeploy.jpg)
