...
::: good  
![Figure: Good Example - If you want to avoid migrating then SSW Access Reporter delivers your Access reports online so you can view them anywhere](/rules/two-migration-options-to-show-acccess-reports-on-web/ReportManager.gif)
:::
...
::: good  
![Figure: Good Example - Reporting Services has built-in support for importing your Access reports](/rules/two-migration-options-to-show-acccess-reports-on-web/rsrulesimportreports.gif)
:::
