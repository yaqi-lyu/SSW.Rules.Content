...
![Figure: #1 Create an appsettings.Local.json file. Set this to be ignored by your source code control system](/rules/add-local-configuration-file-for-developer-specific-settings/local-config-file-1.png)  

![Figure: #2 Add code to apply this configuration file in Program.cs](/rules/add-local-configuration-file-for-developer-specific-settings/local-config-file-2.jpg)  
