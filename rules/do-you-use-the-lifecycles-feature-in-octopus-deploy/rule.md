...
![Figure: Lifecycles can be found in the Library](/rules/do-you-use-the-lifecycles-feature-in-octopus-deploy/Octopus_Lifecycles.png)  
...
::: good  
![Figure: Good Example - This lifecycle has two phases: an automatic release to a Staging server, and a manual release to the Production server.](/rules/do-you-use-the-lifecycles-feature-in-octopus-deploy/SugarLearning_Lifecycle.png)  
:::
...
::: good  
![Figure: Good Example - This combination results in Continuous Deployment to the Staging server when a new package is pushed](/rules/do-you-use-the-lifecycles-feature-in-octopus-deploy/Lifecycle_CI.png)  
:::
