...
![Figure: The out of the box visuals from Power BI](/rules/power-bi-visualizations/visualizations.jpg)
...
![Figure: Use when: Comparing categories or tracking changes over time.](/rules/power-bi-visualizations/column-chart.jpg)

## Stacked Column Chart

![Figure: Use when: Comparing parts of a whole across categories.](stacked-/rules/power-bi-visualizations/column-chart.jpg)

## Clustered Column Chart

![Figure: Use when: Comparing multiple categories and their sub-categories.](/rules/power-bi-visualizations/clustered-columns.jpg)

## 100% Stacked Column Chart

![Figure: Use when: Showing the percentage distribution across categories.](/rules/power-bi-visualizations/100-stacked-columns.jpg)

## Bar Chart

![Figure: Use when: Comparing categories horizontally.](/rules/power-bi-visualizations/bar-chart.jpg)

## Stacked Bar Chart

![Figure: Use when: Comparing parts of a whole across categories horizontally.](stacked-/rules/power-bi-visualizations/bar-chart.jpg)

## Clustered Bar Chart

![Figure: Use when: Comparing multiple categories and their sub-categories horizontally.](clustered-/rules/power-bi-visualizations/bar-chart.jpg)

## 100% Stacked Bar Chart

![Figure: Use when: Showing the percentage distribution across categories horizontally.](/rules/power-bi-visualizations/100-stacked-bars.jpg)

## Line Chart

![Figure: Use when: Displaying trends over time.](/rules/power-bi-visualizations/line-chart.jpg)

## Line and Stacked Column Chart

![Figure: Use when: Combining trends and part-to-whole relationships.](line-and-stacked-/rules/power-bi-visualizations/column-chart.jpg)

## Ribbon Chart

![Figure: Use when: Visualizing ranking changes in a category over time.](/rules/power-bi-visualizations/ribbon-chart.jpg)

## Area Chart

![Figure: Use when: Demonstrating the magnitude of change over time.](/rules/power-bi-visualizations/area-chart.jpg)
...
![Figure: Use when: Breaking down the contribution of different components to a whole over time.](stacked-/rules/power-bi-visualizations/area-chart.jpg)
...
![Figure: Use when: Illustrating proportions within a whole.](/rules/power-bi-visualizations/pie-chart.jpg)
...
![Figure: Use when: Similar to a pie chart but with a hole in the center, to emphasize the parts-to-whole relationship.](/rules/power-bi-visualizations/donut.jpg)
...
![Figure: Use when: Displaying hierarchical data as part of a whole with nested rectangles.](/rules/power-bi-visualizations/treemap.png)
...
![Figure: Use when: Showing geographical data.](/rules/power-bi-visualizations/map.jpg)

## Filled Map

![Figure: Use when: Displaying how a value varies across geographic regions, with areas filled in color.](filled-/rules/power-bi-visualizations/map.jpg)

## Azure Map

![Figure: Use when: Integrating geographical data with the advanced spatial analytics capabilities of Azure.](azure-/rules/power-bi-visualizations/map.jpg)
...
![Figure: Use when: Leveraging advanced GIS (Geographic Information Systems) capabilities for sophisticated and detailed geographic data analysis.](/rules/power-bi-visualizations/arcgis-map.png)
...
![Figure: Use when: Investigating the relationship between different variables.](/rules/power-bi-visualizations/scatter-chart.jpg)
...
![Figure: Use when: Showing a sequential breakdown of intermediate values leading to a final result.](/rules/power-bi-visualizations/waterfall-chart.png)
...
![Figure: Use when: Displaying the flow through a process or funnel.](/rules/power-bi-visualizations/funnel-chart.png)

## Gauge Chart

![Figure: Use when: Illustrating progress toward a goal or a current value within a range.](/rules/power-bi-visualizations/gauge-chart.png)
...
![Figure: Use when: Showcasing a single key performance indicator.](/rules/power-bi-visualizations/kpi.png)
...
![Figure: Use when: Highlighting a single value prominently.](/rules/power-bi-visualizations/card.jpg)

## Multi-Row Card

![Figure: Use when: Displaying a list of multiple key metrics or attributes.](multi-row-/rules/power-bi-visualizations/card.jpg)

## Table

![Figure: Use when: Presenting detailed data and metrics in a grid format.](/rules/power-bi-visualizations/table.jpg)

## Matrix

![Figure: Use when: Showing data structured in rows and columns, often with aggregates.](/rules/power-bi-visualizations/matrix.png)
...
![Figure: Use when: Allowing users to filter and segment the data interactively.](/rules/power-bi-visualizations/slicer.jpg)

## Key Influencers

![Use when: You want to identify and display which factors most significantly affect a chosen metric or outcome.](/rules/power-bi-visualizations/key-influencers.png)
...
![Figure: Use when: You need to explore data hierarchically and break down a metric into its contributing factors to understand the root causes or influences. ](/rules/power-bi-visualizations/decomposition-tree.png)
...
![Figure: Use when: You want to interact with your data using natural language queries to get immediate visual responses.](/rules/power-bi-visualizations/q-a.png)
...
![Figure: Use when: Generating summaries and insights from your visuals and data points.](/rules/power-bi-visualizations/smart-narrative.png)
...
![Figure: Use when:** Tracking and displaying key metrics at a glance, often in a scorecard format that highlights data trends and goal progress. ](/rules/power-bi-visualizations/metrics.png)
...
![Figure: Use when: You require printable, pixel-perfect reports that can be distributed across your organization in a consistent format. ](/rules/power-bi-visualizations/paginated-reports.png)
...
![Figure: Use when: Integrating interactive applications within your Power BI reports. ](/rules/power-bi-visualizations/power-app.png)
...
![Figure: Use when: Adding a button to kick off an automation based on insights gained from your Power BI data.](/rules/power-bi-visualizations/power-automate.jpg)
