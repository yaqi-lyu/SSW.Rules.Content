...
![](/rules/do-you-know-this-quick-fix-for-sharepoint-javascript-errors-that-prevents-you-from-switching-page-layout/PagelayoutInRibbon.jpg)**Figure: Click Page Layout in the Ribbon**
...
2. Restrict the valid number of page layouts that can be used, instead of allowing "Pages in this site can use any layout"![](/rules/do-you-know-this-quick-fix-for-sharepoint-javascript-errors-that-prevents-you-from-switching-page-layout/RestrictedPageLayout.jpg) **Figure: Restrict valid page layouts**
3. This fixes the Ribbon menu
![](/rules/do-you-know-this-quick-fix-for-sharepoint-javascript-errors-that-prevents-you-from-switching-page-layout/RibbonMenu01.jpg) **Figure: Ribbon menu fixed!**
