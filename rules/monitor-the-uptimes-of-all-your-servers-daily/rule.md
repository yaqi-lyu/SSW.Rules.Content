...
::: good
![Figure: Good example - WhatsUp Gold - Green indicates servers are healthy](/rules/monitor-the-uptimes-of-all-your-servers-daily/WuGReport.png)
:::
...
::: good
![Figure: OK Example - Editing WUG's email action is simple, but HTML skills are necessary to make a good looking report](/rules/monitor-the-uptimes-of-all-your-servers-daily/wugemail.jpg)
:::
...
::: good
![Figure: Good example - Email - Nicely branded email, red indicates servers are not healthy ](/rules/monitor-the-uptimes-of-all-your-servers-daily/unhealthy.jpg)
:::
