...
::: bad
![Figure: Bad example - Using an InternalsVisibleTo attribute in the csproj](/rules/use-iapimarker-with-webapplicationfactory/Using-InternalsVisibleTo-attribute.jpg)
:::
...
::: bad
![Figure: Bad example - Using a public partial program class](/rules/use-iapimarker-with-webapplicationfactory/Using-public-partial-program-class.jpg)
:::
...
::: good
![Figure: Good example - Using an IApiMarker interface](/rules/use-iapimarker-with-webapplicationfactory/Using-IApiMarker-interface.jpg)
:::
