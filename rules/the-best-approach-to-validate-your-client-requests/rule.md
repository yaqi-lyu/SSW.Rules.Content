...
::: bad  
![Figure: Bad Example - Managing Request Validation within the Controller](/rules/the-best-approach-to-validate-your-client-requests/validate-client-requests-bad.png)  
:::
...
![Figure: OK Example - Validation Handled Manually within Request Handler Ensuring All Requests are Validated](/rules/the-best-approach-to-validate-your-client-requests/validate-client-requests-ok.png)  
...
::: good  
![Figure: Good Example - Automatically Validate All Requests By Using a MediatR Pipeline Behaviour](/rules/the-best-approach-to-validate-your-client-requests/validate-client-requests-good.png)  
:::
...
::: good  
![Figure: Good Example – Use an ExceptionFilterAttribute to Catch and Handle Exceptions within the Web API](/rules/the-best-approach-to-validate-your-client-requests/validate-client-requests-good-2.png)  
:::
