...
::: good  
![Figure: Good Example - The Microsoft ASP.NET and Azure teams both do a great job of providing documentation on how to start contributing](/rules/how-to-get-involved-with-your-project/getinvolved1.png)  
:::


::: good  
![Figure: Good Example - The ASP.NET team (and the SSW team) use a common CONTRIBUTING.md in a common 'Home' repository. This ensures that all projects for their team are collaborated on in the same way](/rules/how-to-get-involved-with-your-project/getinvolved2.png)  
:::
