...
![Figure: Search for Lync application in App store.](/rules/do-you-install-the-ios-versions/Lync1.png)  

2. Install the Lync client on device
3. Set up Lync to sign into your account as follows: 
      
![Figure: you just need to enter 3 fields](/rules/do-you-install-the-ios-versions/Lync2.png)  
