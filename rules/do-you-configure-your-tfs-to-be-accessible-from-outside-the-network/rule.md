...
![Rule to forward port 80 to the TFS port](/rules/do-you-configure-your-tfs-to-be-accessible-from-outside-the-network/tfs-firewall-rule-80.gif)    Figure: Rule to forward port 80 to the TFS port
