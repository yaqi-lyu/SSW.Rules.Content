...
::: bad  
![Figure: Bad example – C# project with reports opening as XML](/rules/use-report-server-project/report-server-project1.png)  
:::
...
1. Be sure that you VS has the tool/extensions Microsoft Reporting Services Projects installed, go to **Tools** | **Extensions and Updates** | **Online**, and search for services
  ...
  ![Figure: Checking Microsoft Reporting Services Projects is installed](/rules/use-report-server-project/report-server-project2.png)  
...
2. Create the project selecting **Business Intelligence** |  **Reporting Services** |  **Report Server Project** 
  ...
  ![](/rules/use-report-server-project/report-server-project3.png)  

3. Add existing reports and create your new DataSource (based in the information on your Report Portal)


::: good  
![Figure: Good Example – Report Server project with reports opening in the design/preview view](/rules/use-report-server-project/report-server-project4.png)  
:::
